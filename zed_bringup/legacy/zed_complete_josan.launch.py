...
def generate_launch_description():
    ...
    declared_args = [
        ...
        DeclareLaunchArgument('camera_id_1', default_value=EnvironmentVariable('JETSON_CAMERA_1_ID', default_value='top_rgbd_camera')),

        DeclareLaunchArgument('camera_model_2', default_value=EnvironmentVariable('JETSON_CAMERA_2_MODEL', default_value='none')),
        DeclareLaunchArgument('camera_device_id_2', default_value=EnvironmentVariable('JETSON_CAMERA_2_DEVICE_ID', default_value='1')),
